            ...
            <b-col md="3">
              <label>
                <n-popover trigger="hover" placement="top-start">
                  ...
                  <span v-html="this.DisplayConfiguration.properties.window_dimensions.description"></span>
                </n-popover>
                Window dimensions:
              </label>
            </b-col>
            <b-col md="4">
              <b-form-select v-model="window_display.window_dimensions" :options="WindowDimensionsType"/>
            </b-col>
          </b-row>
...
export default {
  ...
  data() {
    return {
      ...
      WindowDimensionsType: this.rootSchema.definitions['WindowDimensionsType']['enum'],
