        ...
        if gpu.text is not None:
            ...
            for display in gpu.xpath("./displays/display"):
                if display_type == "Window":
                    window_dimensions = display.xpath("./window_dimensions")[0].text if display.xpath("./window_dimensions") else None
                    ...
                    self.gpu.append((display_type, window_dimensions, horizontal_offset, vertical_offset))
        ...
        if len(displays) > 0:
            ...
            for display in displays:
                if display[0] == "Window":
                    ...
                    etree.SubElement(display_node, "window_dimensions").text = display[1]
